  ...
  <footer className="border-t border-border bg-card/50">
    <div className="container mx-auto px-4 py-12">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              <Link key={l.to} to={l.to} className="text-muted-foreground hover:text-accent text-xs transition-colors">
                {l.label}
              </Link>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {["الکترونیک", "اکسسوری", "مد و فشن", "زیبایی"].map(c => (
              <Link key={c} to="/products" className="text-muted-foreground hover:text-accent text-xs transition-colors">
                {c}
              </Link>
            ))}
          </div>
      ...
      <div className="border-t border-border pt-6 text-center">
        ...
        <p className="text-accent text-xs mt-2 font-display font-semibold">
