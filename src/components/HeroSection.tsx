    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={heroWater}
          alt="Hero"
          className="w-full h-full object-cover animate-water opacity-40"
          width={1920}
          height={1080}
        />
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted-foreground mb-8 max-w-xl mx-auto font-body">
        ...
        >
          <a
            href="/products"
            className="px-8 py-4 bg-accent text-accent-foreground rounded-lg font-semibold text-sm hover:opacity-90 transition-all shadow-lg"
          >
            مشاهده محصولات ←
          </a>
          <a
            href="/about"
            className="px-8 py-4 border border-primary/30 rounded-lg font-semibold text-sm text-foreground/80 hover:bg-secondary transition-all"
          >
            درباره کریمی
          </a>
        </motion.div>
